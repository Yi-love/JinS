...
(function() {
	 ...
	 */
	function test(){
		var a =[22 ,2 ,3 , 34 , 676 , 564];
		console.log('indexOf' , a.indexOf(3 , '-9'));
		console.log('lastIndexOf' , a.lastIndexOf(676 , '6'));

		function addRounded (previousValue, currentValue) {
	    	return previousValue + Math.round(currentValue);
	    };
		console.log('reduce' , a.reduce(addRounded , 0));
		console.log('reduceRight' , a.reduce(addRounded , 0));
		a.forEach(function(i){
			console.log('forEach' , i);
		});
		a.filter(function(i){
			console.log('filter' , i>10);
		});
		a.map(function(i){
			console.log('map' , [22]);
		});
		a.some(function(i){
			console.log('some' , i > 10);
		});
		a.every(function(i){
			console.log('every' , i < 10);
		});
	};
